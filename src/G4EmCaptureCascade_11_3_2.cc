...
G4EmCaptureCascade_11_3_2::G4EmCaptureCascade_11_3_2() : G4HadronicInteraction("emCaptureCascade")
{
...
G4EmCaptureCascade_11_3_2::~G4EmCaptureCascade_11_3_2() { }

G4HadFinalState *G4EmCaptureCascade_11_3_2::ApplyYourself(const G4HadProjectile &projectile, G4Nucleus &targetNucleus)
{
  result.Clear();
...
void G4EmCaptureCascade_11_3_2::ModelDescription(std::ostream &outFile) const
{
