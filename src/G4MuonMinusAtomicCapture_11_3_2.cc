...
//
// File name:     G4MuonMinusAtomicCapture_11_3_2
//
...
// Stopping of mu-
//
// G4VParticleChange will contain gammas from G4EmCaptureCascade_11_3_2 and
...
G4MuonMinusAtomicCapture_11_3_2::G4MuonMinusAtomicCapture_11_3_2(const G4String &name)
    : G4VRestProcess(name, fHadronic),
      fElementSelector(new G4ElementSelector()),
      fEmCascade(new G4EmCaptureCascade_11_3_2()),  // Owned by InteractionRegistry
...
G4MuonMinusAtomicCapture_11_3_2::~G4MuonMinusAtomicCapture_11_3_2()
{
  G4HadronicProcessStore::Instance()->DeRegisterExtraProcess(this);
  delete theTotalResult;
}

G4bool G4MuonMinusAtomicCapture_11_3_2::IsApplicable(const G4ParticleDefinition &p)
{
  return (&p == G4MuonMinus::MuonMinus());
}

void G4MuonMinusAtomicCapture_11_3_2::PreparePhysicsTable(const G4ParticleDefinition &p)
{
  G4HadronicProcessStore::Instance()->RegisterParticleForExtraProcess(this, &p);
}

void G4MuonMinusAtomicCapture_11_3_2::BuildPhysicsTable(const G4ParticleDefinition &p)
{
  G4HadronicProcessStore::Instance()->PrintInfo(&p);
}

G4double G4MuonMinusAtomicCapture_11_3_2::AtRestGetPhysicalInteractionLength(
...
G4VParticleChange *G4MuonMinusAtomicCapture_11_3_2::AtRestDoIt(const G4Track &track, const G4Step &)
{
...
void G4MuonMinusAtomicCapture_11_3_2::ProcessDescription(std::ostream &outFile) const
{
